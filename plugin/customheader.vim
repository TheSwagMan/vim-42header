...
"                                                 / `L     `._  _,'  ' `.      "
"                                                /    `--.._  `',.   _\  `     "
"  C: 2017/10/21 17:08 by Nobody                 `-.       /\  | `. ( ,\  \    "
"  M: 2017/10/21 17:08 by Nobody                _/  `-._  /  \ |--'  (     \   "
"                                              '  `-.   `'    \/\`.   `.    )  "
...
"                                                 / `L     `._  _,'  ' `.      "
"                                                /    `--.._  `',.   _\  `     "
"  C: 2017/08/04 23:58 by Thomas POTIER          `-.       /\  | `. ( ,\  \    "
/* M: 2017/10/21 17:05 by Nobody                _/  `-._  /  \ |--'  (     \  */
"                                              '  `-.   `'    \/\`.   `.    )  "
"  CustomHeader ! v1.0                               \  -hrr-    \ `.  |    |  "
" **************************************************************************** "
...
function! s:update()
	call s:filetype()
	if getline(s:modline) =~ s:start . repeat(' ', s:margin - strlen(s:start)) . "M: "
		if &mod
